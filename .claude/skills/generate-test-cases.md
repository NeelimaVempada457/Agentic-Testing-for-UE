...
ARTIFACTS SAVED TO:
  ...
  [BASE_DIR]/application-analysis/app-flow-analysis.md
  [BASE_DIR]/application-analysis/detected-modules.md
  [BASE_DIR]/application-analysis/discrepancies.md ← ALWAYS present
  [BASE_DIR]/application-analysis/screenshots/     ← one screenshot per discrepancy (DISC-NNN-[slug].png)
  [BASE_DIR]/application-analysis/requirements-vs-app.md  ← (Jira mode only)
...
DISCREPANCIES FOUND:               [N]
  ...
  Medium Severity:                 [N]
  Low Severity:                    [N]
  → See: [BASE_DIR]/application-analysis/discrepancies.md

NEXT STEPS:
  1. Review discrepancies.md and raise defects for High severity items
  2. Review traceability-matrix.md for AC coverage gaps
  3. Review requirements-vs-app.md for implementation gaps
  4. Use playwright-test-generator to convert .feature files to scripts
  5. Fix any "REQUIREMENT GAP" items with the development team
  6. Run /jira-sprint to process the full sprint
==================================================
```
